...
export function OurMission() {
  ...
  return (
    <section className="relative bg-[#AA0EBA] py-28 px-6 md:px-16 lg:px-24 text-white overflow-hidden">
      {/* Ambient gradients */}
      <div className="absolute -top-32 right-0 w-[400px] h-[400px] bg-purple-300/20 blur-[140px] rounded-full" />
      <div className="absolute -bottom-20 left-0 w-[380px] h-[380px] bg-pink-300/20 blur-[120px] rounded-full" />
      ...
      <div className="relative max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-24 relative items-start">
          ...
          <div className="md:sticky md:top-28 self-start">
            ...
            <h2 className="mt-4 text-4xl md:text-5xl lg:text-[56px] font-bold leading-[1.1] tracking-tight">
              Help Nigerians build stronger financial habits and long-term
              stability.
            </h2>
        ...
        {/* Testimonial Slider */}
        <div
          className="mt-24 bg-[#3D003E] rounded-2xl overflow-hidden p-8 md:p-12 lg:p-16 min-h-[520px] flex flex-col md:flex-row items-center gap-12 shadow-2xl relative z-10"
          ...
          <div className="w-full md:w-1/2 flex justify-center">
            <div
              key={`img-${activeTab}`}
              className="relative aspect-[4/5] w-full max-w-[340px] rounded-xl overflow-hidden shadow-2xl transition-opacity duration-500">
              <Image
          ...
          {/* Quote */}
          <div className="w-full md:w-1/2 flex flex-col justify-between min-h-[300px]">
