        ...
        <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-24">
          ...
          <div className="w-full lg:w-1/2 space-y-8 lg:space-y-10 order-1">
            <div className="space-y-6">
              <div className="space-y-2">
                ...
                <p className="text-xl md:text-2xl lg:text-3xl font-semibold text-[#1A1A1A]">
                  TrybeSave is free to start. <br className="hidden md:block" />
                  We earn through:
                </p>
              </div>
            ...
            <p className="text-xl md:text-2xl lg:text-3xl font-bold text-[#0A0A0A] pt-4">
              We never exploit users with <br className="hidden md:block" />{' '}
              hidden fees.
            </p>
          </div>
          ...
          <div className="w-full lg:w-1/2 flex justify-center lg:justify-end order-2">
            <div className="relative w-full max-w-145">
              ...
              <div className="absolute inset-0 bg-slate-50 rounded-3xl blur-3xl -z-10 translate-x-2 translate-y-2" />

              <Image
                src="/content_10_image.png"
                alt="TrybeSave Opportunities showing revenue model examples"
                width={580}
                height={400}
                className="w-full h-auto drop-shadow-[0_20px_50px_rgba(0,0,0,0.1)] rounded-2xl lg:rounded-3xl border border-gray-50/50"
                priority
              />
            </div>
          </div>
