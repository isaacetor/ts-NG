...
export function AboutHero() {
  return (
    <section className="relative bg-[#AA0EBA] min-h-150 w-full flex items-center px-6 py-12 md:px-16 lg:px-24 overflow-hidden">
      {/* Ambient Glows */}
      ...
      <div className="relative max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="text-white space-y-6 z-10">
          ...
          <p className="text-lg md:text-xl lg:text-2xl font-light leading-relaxed max-w-xl opacity-90">
            We&apos;re building a smarter way for people to save money, manage
            their finances, and build long-term financial stability.
          </p>
        </div>
